        ...
        switch (recyclerTag) {
            ...
            case Constant.RV_HOMEWORK_BARRIER:
                ...
                holder.check_box.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                        ...
                        mApiService.updateDivisionsHomeworkBarrierStatus(Constant.SCHOOL_ID, "VS019BH0050",
            ...
            case Constant.RV_QUESTION_BANK_ROW:
                ...
                try {
                    ...
                    holder.tvAddedDate.setText(convertDate);
                        ...
                        builder.setMessage("Are you sure you want to delete")
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        mApiService.deleteQuestionBank("e4b9f0b8-78e6-4cc3-9194-defd7663a213",
                                                strQuestionId).enqueue(new Callback<Object>() {
                                            @Override
                                            public void onResponse(Call<Object> call, Response<Object> response) {
                                                Log.i("Delete_QuesBank***", "" + response.raw().request().url());
                                                ...
                                                if (response.isSuccessful()) {
                                                    try {
                                                        ...
                                                        if (status.equalsIgnoreCase("success")) {
                                                            ...
                                                            intent.putExtra("Assessement_Option","QuestionBank");
