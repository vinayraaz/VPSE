...
public class ExamActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (Assessment_Type){
            ...
            case "QuestionBank":
                ...
                break;
            case "QuestionBankCreate":
                linearLayoutExam.setVisibility(View.GONE);
                linearLayoutSport.setVisibility(View.GONE);
                loadFragment(Constant.QUESTIONBANK__CREATE, null);
                break;
    ...
    void loadFragment(String fragmentString, Bundle bundle) {
        switch (fragmentString) {
            ...
            case Constant.ADD_HOUSES:
                callFragment(new Fragment_AddHouses(), Constant.ADD_HOUSES, null, null);
                break;
        }
