...
public class HomeworkViewFragment extends Fragment {
    ...
    TextView tv_work_title, tv_description, tv_fromDate, tv_toDate;
    RecyclerView recycler_view_book, recycler_view_url, recycler_view_attachment;

    APIService apiService;
    String HomeWork_UUID = "",  urlReference = "", urlDescription = "", strAttachment = "";
    ...
    private void getStringBundle() {
        ...
        Log.i("HomeWork_UUID**", "" + HomeWork_UUID);

/*
        String className = bundle.getString("class");
        String section = bundle.getString("section");
        String work_title = bundle.getString("work_title");
        String description = bundle.getString("description");
        String assign_date = bundle.getString("assign_date");
        String submit_date = bundle.getString("submit_date");

        tv_work_title.setText(work_title);
        tv_description.setText(description);
        tv_fromDate.setText("From: "+assign_date);
        tv_toDate.setText("To: "+submit_date);*/
    }
