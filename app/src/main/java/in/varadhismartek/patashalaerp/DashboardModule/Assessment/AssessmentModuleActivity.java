...
public class AssessmentModuleActivity extends AppCompatActivity implements View.OnClickListener {
    LinearLayout linearLayoutExam,linearLayoutCurricular,linearLayoutSport,ll_questionbank,ll_house;
